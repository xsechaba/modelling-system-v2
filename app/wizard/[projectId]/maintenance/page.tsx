  ...
  return (
    <div style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{ flex: 1, padding: '32px', overflowY: 'auto', background: 'var(--bg-page)' }}>
        ...
        {activeTab === 'logs' && (
          <div className="animate-fade-in" style={{ height: '100%', background: 'var(--bg-code)', border: '1px solid var(--color-border)', borderRadius: '8px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
