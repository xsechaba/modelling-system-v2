    ...
    <div style={{ height: '100vh', display: 'flex', background: '#050505', color: 'var(--color-white)' }}>
      ...
      <div style={{ flex: 1, borderRight: '1px solid var(--color-border)', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', padding: '48px', background: 'radial-gradient(circle at 0% 0%, rgba(134,188,37,0.15) 0%, transparent 50%)' }}>
        ...
        <div>
          ...
          <p style={{ color: 'var(--color-white-muted)', fontSize: '1.125rem', maxWidth: '400px', lineHeight: 1.6 }}>
            Join data teams using AI to architect, generate, and deploy dimensional models 10x faster.
          </p>
        </div>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px' }}>
        <div style={{ width: '100%', maxWidth: '400px' }}>
          <h2 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '8px' }}>Create an Account</h2>
          ...
          <form onSubmit={registerUser} style={{ display: 'flex', flexDirection: 'column', gap: '20px' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '0.8125rem', color: 'var(--color-white-muted)', marginBottom: '8px' }}>Password</label>
              <div style={{ position: 'relative' }}>
          ...
          <div style={{ marginTop: '32px', textAlign: 'center', fontSize: '0.875rem', color: 'var(--color-white-muted)' }}>
            Already have an account? <Link href="/auth/login" style={{ color: 'var(--color-green)', textDecoration: 'none', fontWeight: 600 }}>Log in</Link>
          </div>
        </div>
      </div>
    </div>
